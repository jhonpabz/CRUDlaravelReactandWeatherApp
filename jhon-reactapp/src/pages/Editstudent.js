                        ...
                        <div className="col-md-6">
                            <div className="card">
                                <div className="card-header">
                                    <h4>Edit Students
                                        <Link to={'/'}  className="btn btn-outline-secondary float-end"><i className="fas fa-long-arrow-alt-left"></i></Link>
                                    </h4>
                                </div>
                                <div className="card-body">
                                    ...
                                    <form onSubmit={this.updateStudent}>
                                        ...
                                        <div className="form-group mb-3">
                                            <button type="submit" id="updateBtn" className="btn stud-btn">Update Student</button>
